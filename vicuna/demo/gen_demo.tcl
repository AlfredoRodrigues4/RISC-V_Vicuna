...
set_property -name "platform.description" -value "Vivado generated platform" -objects $obj
set_property -name "platform.dr_bd_base_address" -value "0" -objects $obj
# Remover a linha abaixo, pois "platform.emu_dir" não é uma propriedade válida
