...
/*
Este codigo basicamente faz a inferencia e mede a inferencia do treelite quantizado, nao esquecer que aqui no treelite,
apesar de quantizado, o quantizado e em tempo de compilacao, por isso nao compensa tanto em termos de tempo e espaco
*/
...
int main() {
    ...
    // predict do treelite quantizado
