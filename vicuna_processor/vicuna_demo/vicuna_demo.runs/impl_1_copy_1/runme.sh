...
HD_PWD='/home/alfredo/vicuna_processor/vicuna_demo/vicuna_demo.runs/impl_1_copy_1'
cd "$HD_PWD"
...
EAStep vivado -log demo_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source demo_top.tcl -notrace
